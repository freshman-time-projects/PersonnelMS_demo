...
<body>
	...
	<div id="Head_1">
		<!-- 标题 -->
		<div id="Head_1_Logo">
			<b style="font-family: '黑体'">人事管理系统</b> <!-- <img border="0" src="style/images/logo.png" /> -->
        </div>
		<!-- 欢迎用户的文字 -->
		...
		<div id="Head_1_FunctionButton">
			<a target="right" href="javascript:void(0)" onclick="help()">
				<img width="78" height="20" src="style/images/help2.gif" />
			</a>
			<a target="_parent" href="../usermethod?UserKey=logout">
    ...
    <div id="Head_2">
        ...
        function a(){
        	window.parent.right.location="right.jsp";
        }
         function help(){
        	window.parent.right.location="help.jsp";
        }
