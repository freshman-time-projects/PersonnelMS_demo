...
<div id="formbox">
	<form  id="formpersonal" action="personmethod?PersonMethod=update" method="post" >
	<div class="form">
	<c:forEach var="person" items='${requestScope.persons}'>
		<h3>人才信息</h3>
		<div class="item">
			<span class="label"><span class="red">*</span>员工编号：</span>
			<div class="fl">
				<input type="text" id="referrer" name="id" class="text" tabindex="1" value="${person.id }" readonly="readonly" pattern="^([a-zA-Z0-9\u4e00-\u9fa5\·]{1,10})$" />
		...
		<div class="item">
			...
			<div class="fl">
				<input type="text" id=" " placeholder="请输入真实姓名！" name="name" class="text" tabindex="1" value="${person.name }" pattern="^([a-zA-Z0-9\u4e00-\u9fa5\·]{1,10})$" />
				<label id="username_succeed" class="blank"></label>
				<span class="clear"></span>
				<div id="username_error"></div>
			</div>
        ...
        <div class="item">
			...
			<div class="fl">
				<input type="text" id=" " placeholder="请输入20~60之间的整数" name="age" class="text" tabindex="5" value="${person.age }" pattern="^([2-5]\d)|60$"/>
        ...
        <div class="item">
			...
			<div class="fl">
				<input type="text" id=" " name="sex" class="text" maxlength=1 tabindex="5" value="${person.sex }"/>
				<label id="referrer_succeed" class="blank invisible"></label>
				<span class="clear"></span>
				<label id="referrer_error"></label>
			</div>
          ...
          <div class="item">
			...
			<div class="fl">
				<input type="text" id=" " name="married" class="text" maxlength=2 tabindex="5" value="${person.married }" />
				<label id="referrer_succeed" class="blank invisible"></label>
				<span class="clear"></span>
				<label id="referrer_error"></label>
			</div>
        ...
        <div class="item">
			...
			<div class="fl">
				<input type="text" id=" " name="idcard" class="text" maxlength=18 tabindex="5" value="${person.idcard }" pattern="^([0-9]{15}|[0-9]{18})$"/>
				<label id="referrer_succeed" class="blank invisible"></label>
				<span class="clear"></span>
				<label id="referrer_error"></label>
			</div>
         ...
         <div class="item">
			...
			<div class="fl">
				<input type="text" id=" " name="edu" class="text"  tabindex="5" value="${person.edu }"  >
				<label id="referrer_succeed" class="blank invisible"></label>
				<span class="clear"></span>
				<label id="referrer_error"></label>
			</div>
        ...
        <div class="item">
			...
			<div class="fl">
				<input type="text" id=" " name="school" class="text" tabindex="5" value="${person.school }" />
				<label id="referrer_succeed" class="blank invisible"></label>
				<span class="clear"></span>
				<label id="referrer_error"></label>
			</div>
		...
		<div class="item">
			...
			<div class="fl">
				<input type="text" id=" " name="mobile" maxlength="11" class="text" tabindex="10" value="${person.mobile }" pattern="^1[0-9]{10}$"/>
		...
		<div class="item">
			...
			<div class="fl">
				<input type="text" id=" " name="address" class="text" value="${person.address }" tabindex="11"/>
		...
		<div class="item">
			...
			<div class="fl">
				<input type="text" id=" " name="email" class="text" tabindex="4" value="${person.email}" pattern="^[a-z0-9]+([._\\-]*[a-z0-9])*@([a-z0-9]+[-a-z0-9]*[a-z0-9]+.){1,63}[a-z0-9]+$" />
